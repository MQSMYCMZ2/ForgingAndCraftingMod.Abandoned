...
public class ForgingHouseFeature extends Feature<NoneFeatureConfiguration> {
	public static ForgingHouseFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new ForgingHouseFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("forging_and_crafting:forging_house", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("forging_and_crafting:forging_house", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("forging_and_crafting", "forging_house"));
		if (template == null)
			return false;
