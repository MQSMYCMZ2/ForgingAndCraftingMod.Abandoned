...
package net.mqsmycmz.forgingandcrafting.world.features;
...
public class CopperTreeFeature extends Feature<NoneFeatureConfiguration> {
	public static CopperTreeFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new CopperTreeFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("forging_and_crafting:copper_tree", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("forging_and_crafting:copper_tree", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public CopperTreeFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(ForgingAndCraftingModBlocks.FORGING_WORLD_GLASS_BLOCK.get());
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("forging_and_crafting", "copper_tree"));
		if (template == null)
			return false;
