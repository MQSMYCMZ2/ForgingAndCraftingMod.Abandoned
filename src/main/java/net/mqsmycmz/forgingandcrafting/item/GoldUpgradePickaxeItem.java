...
import net.mqsmycmz.forgingandcrafting.procedures.GoldUpgradePickaxeDanggongJuChuZaiShouShangShiProcedure;
...
public class GoldUpgradePickaxeItem extends PickaxeItem {
	public GoldUpgradePickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 4090;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			GoldUpgradePickaxeDanggongJuChuZaiShouShangShiProcedure.execute(entity);
	}
}
