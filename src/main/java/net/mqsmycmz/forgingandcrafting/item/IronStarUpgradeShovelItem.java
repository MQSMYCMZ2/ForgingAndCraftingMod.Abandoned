...
import net.mqsmycmz.forgingandcrafting.procedures.IronStarUpgradeShovelDangGongJuChuXianZaiShouZhongShiProcedure;
...
public class IronStarUpgradeShovelItem extends ShovelItem {
	public IronStarUpgradeShovelItem() {
		super(new Tier() {
			public int getUses() {
				return 3080;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			IronStarUpgradeShovelDangGongJuChuXianZaiShouZhongShiProcedure.execute(entity);
	}
}
