...
import net.mqsmycmz.forgingandcrafting.procedures.DiamondStarUpgradeShovelDGJCZSSSProcedure;
...
public class DiamondStarUpgradeShovelItem extends ShovelItem {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			DiamondStarUpgradeShovelDGJCZSSSProcedure.execute(entity);
	}
}
