...
import net.mqsmycmz.forgingandcrafting.procedures.GoldUpgradeAxeDGJCZSSSProcedure;
...
public class GoldUpgradeAxeItem extends AxeItem {
	public GoldUpgradeAxeItem() {
		super(new Tier() {
			public int getUses() {
				return 4090;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			GoldUpgradeAxeDGJCZSSSProcedure.execute(entity);
	}
}
