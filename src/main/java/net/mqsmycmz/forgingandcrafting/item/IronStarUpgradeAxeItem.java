...
import net.mqsmycmz.forgingandcrafting.procedures.IronStarUpgradeAxeDangGongJuChuXianZaiShouZhongShiProcedure;
...
public class IronStarUpgradeAxeItem extends AxeItem {
	public IronStarUpgradeAxeItem() {
		super(new Tier() {
			public int getUses() {
				return 3080;
			}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		if (selected)
			IronStarUpgradeAxeDangGongJuChuXianZaiShouZhongShiProcedure.execute(entity);
	}
}
