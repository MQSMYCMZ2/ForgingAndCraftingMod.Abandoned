...
public class AdvancedWorkbenchBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("advanced_workbench");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new AdvancedWorkbenchGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
